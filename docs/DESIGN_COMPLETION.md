...
Date: 2026-09-15  
Scope: In-repo implementation of `docs/DESIGN.md` through batches 1–8.
...
| Real AutoLive2d import | Binary not present (`AI2LIVE_AUTOLIVE2D_CMD`) | `scripts/mock-rig/autolive2d-mock.mjs` |
